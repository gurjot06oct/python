...
# prints
print("append():", my_list)  # [6]
print("clear():", my_list)   # []
print("copy():", copied_list)  # [1, 2, 3]
print("count():", count_of_2)  # 1


# extend(): Add the elements of a list (or any iterable), to the end of the current list
original_list.extend([4, 5, 6])
print("extend():", original_list)  # [1, 2, 3, 4, 5, 6]

# index(): Returns the index of the first element with the specified value
index_of_3 = original_list.index(3)
print("index():", index_of_3)  # 2

# insert(): Adds an element at the specified position
original_list.insert(2, 2.5)
print("insert():", original_list)  # [1, 2, 2.5, 3, 4, 5, 6]

# pop(): Removes the element at the specified position
popped_element = original_list.pop(2)
print("pop():", popped_element)  # 2.5

# remove(): Removes the item with the specified value
original_list.remove(3)
print("remove():", original_list)  # [1, 2, 4, 5, 6]

# reverse(): Reverses the order of the list
original_list.reverse()
print("reverse():", original_list)  # [6, 5, 4, 2, 1]


# sort(): Sorts the list
original_list.sort()
print("sort():", original_list)  # [1, 2, 4, 5, 6]

another_list = [-1,-3,-5,2,4,6]
another_list.sort(key= lambda x:x*x)
print(another_list) # [-1, 2, -3, 4, -5, 6]
another_list.sort(reverse=True)
print(another_list) # [6, 4, 2, -1, -3, -5]